                            ...
                            if len(command) > 2:
                                if len(command) < 4:
                                    ...
                                    try:
                                        ...
                                        print('Usage:\tget <type> <src.object>\n\tget <type:food/weapon> <src.object> <amount>\nAmount must be integer.')
                            else:
        ...
        if command[0] == '.':
            ...
            if len(command) > 1:
                if command[1].upper() == 'WEAPONS':
                    utils.listItems(listedItems=entities.player.inventory, objType=src.obj.Weapon)
                elif command[1].upper() == 'FOOD':
                    utils.listItems(listedItems=entities.player.inventory, objType=src.obj.Food)
